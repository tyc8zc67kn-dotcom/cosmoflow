...
if reference_sha != EXPECTED_REFERENCE_SHA256:
    raise RuntimeError(
        f"FAIL_REFERENCE_INTEGRITY expected={EXPECTED_REFERENCE_SHA256} observed={reference_sha}"
    )

# Generate the baseline using the unchanged historical V1.1 runner.
subprocess.run(
